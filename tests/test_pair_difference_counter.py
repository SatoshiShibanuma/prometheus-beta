...
def test_basic_pairs():
    ...
    assert count_pairs_with_difference_of_five([1, 6, 3, 8, 4, 9]) == 2
...
def test_negative_numbers():
    ...
    assert count_pairs_with_difference_of_five([-1, 4, 0, 5, 10, 5]) == 2
...
def test_absolute_difference():
    ...
    assert count_pairs_with_difference_of_five([6, 1, 9, 4, 14, 9]) == 2